...
import com.interviewai.backend.dto.JwtResponse;
import com.interviewai.backend.dto.LoginRequest;
import com.interviewai.backend.dto.MessageResponse;
import com.interviewai.backend.dto.SignupRequest;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        User user = User.builder()
                ...
                .role(signUpRequest.getRole() != null && signUpRequest.getRole().equalsIgnoreCase("ADMIN") ? Role.ROLE_ADMIN : Role.ROLE_USER)
                .totalScore(0)
                .build();
